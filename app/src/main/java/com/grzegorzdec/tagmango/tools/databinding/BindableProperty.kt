 ...
 */
fun <ST> NotifiableObservable.bindable(initialValue: ST): BindableProperty<ST> =
    BindableProperty(initialValue, this, Functions.areNotEqual)
 ...
 * @param ST the base type of the source observable ([ObservableProperty.Source]).
 */
fun <ST> NotifiableObservable.bindableEvent(initialValue: ST): BindableProperty<ST> =
    BindableProperty(initialValue, this, Functions.alwaysEqual)
